...
import { PlayerRegistrationEdit } from "src/components/panel/player-registration/player-registration-edit";
import { PlayerRegistrationPromotion } from "src/components/panel/player-registration/player-registration-promotion";
...
const PlayerRegistrationPayment = ({
    ...
    return (
        <PoorConfirmation
            ...
            isLoading={setPaymentStatusMutation.isPending}>
            <span
