...
import type { TimerSettings } from "src/states/timer-states";
import type { TextActions, TextSettings } from "src/app/[locale]/(tools)/tools/[raceId]/precise-clock/precise-lock";
