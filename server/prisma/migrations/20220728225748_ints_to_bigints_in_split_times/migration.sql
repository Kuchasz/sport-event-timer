/*
  ...
  - You are about to alter the column `adjustedTime` on the `SplitTime` table. The data in that column could be lost. The data in that column will be cast from `Int` to `BigInt`.
  - You are about to alter the column `measuredTime` on the `SplitTime` table. The data in that column could be lost. The data in that column will be cast from `Int` to `BigInt`.
