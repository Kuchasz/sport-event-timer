    ...
    <div className="flex items-center my-4 px-4 text-white">
      ...
      <div className="flex items-center mr-4">
        <img
          ...
          src="assets/typical_system_admin.png"
        />
  ...
  <Link href={n.to}>
    <div
      className={classNames(
        "py-4 cursor-pointer px-6 flex items-center text-sm",
        {
          ...
          {raceId && (
            <div className="flex flex-grow overflow-y-hidden">
              <nav className="w-60 py-4 flex-col shadow-lg rounded-tr-md bg-white">
                {menuItems.map((mi) => (
                  <>
                    <div className="uppercase px-6 py-4 text-2xs">
                      {mi.name}
                    </div>
                    {mi.items.map((n) => (
                      <MenuButton
              ...
              <main className="grow h-full overflow-y-auto p-8">
                <div className="p-4 h-full bg-white rounded-md shadow-md">
                  {children}
                </div>
              </main>
            </div>
