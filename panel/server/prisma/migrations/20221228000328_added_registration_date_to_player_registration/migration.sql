...
INSERT INTO "new_PlayerRegistration" ("birthDate", "city", "country", "email", "gender", "icePhoneNumber", "id", "lastName", "name", "phoneNumber", "raceId", "registrationDate", "team") SELECT "birthDate", "city", "country", "email", "gender", "icePhoneNumber", "id", "lastName", "name", "phoneNumber", "raceId", strftime('%s', 'now') * 1000,"team" FROM "PlayerRegistration";
