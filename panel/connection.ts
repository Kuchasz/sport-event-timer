...
const url =
    process.env.NODE_ENV === "production" ? `https://api.rura.cc/api/trpc` : "http://localhost:3001/api/trpc";

const wsUrl =
    process.env.NODE_ENV === "production" ? `wss://api.rura.cc/api/trpc` : "ws://localhost:3001/api/trpc";
