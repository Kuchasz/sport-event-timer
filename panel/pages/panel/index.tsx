            ...
            <div className="border-1 flex flex-wrap h-full border-gray-600 border-solid">
                <DashboardCard title="Number of races">
                    <div className="flex flex-col items-center">
                        ...
                        <div className="text-gray-400 font-normal text-base">Future races: {dashboardData?.futureRaces}</div>
                        <div className="text-gray-400 font-normal text-base">Past races: {dashboardData?.pastRaces}</div>
                    </div>
                </DashboardCard>
                    ...
                    <DashboardCard title="Incoming race">
                        ...
                        <div className="self-end font-semibold text-center">{dashboardData.nextRace.date?.toLocaleDateString()}</div>
                            ...
                            <div className="text-gray-400 font-normal text-base">
                                Registrations: {dashboardData?.nextRace.registeredPlayers} / {dashboardData.nextRace.playersLimit}
                            </div>
                            <div className="text-gray-400 font-normal text-base">
                                Registration:{" "}
