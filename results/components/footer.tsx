    ...
    return (
        <footer>
            <div className="flex flex-col items-center py-8 bg-gray-100 text-white">
                <div className="text-gray-700 font-semibold text-2xl">NASI PARTNERZY</div>
                <div className="h-1 w-10 bg-orange-500 my-6"></div>
                <div className="max-w-6xl flex flex-wrap justify-center items-center">
                    <img className="-m-6 scale-50" src="/assets/partners/logo-maspex.png"></img>
                    <img className="-m-6 scale-50" src="/assets/partners/logo-ceratizit.png"></img>
                    <img className="-m-6 scale-50" src="/assets/partners/logo-decathlon.png"></img>
                    <img className="-m-6 scale-50" src="/assets/partners/logo-eurowafel.png"></img>
                    <img className="-m-6 scale-50" src="/assets/partners/logo-czaniecki-makaron.png"></img>

                    <img className="-m-6 scale-50" src="/assets/partners/logo-euro-stempel.png"></img>

                    <img className="-m-6 scale-50" src="/assets/partners/logo-agropunkt.png"></img>
                    <img className="-m-6 scale-50" src="/assets/partners/logo-kocierz.png"></img>
                    <img className="-m-6 scale-50" src="/assets/partners/logo-gmina-lekawica.png"></img>
                    <img className="-m-6 scale-50" src="/assets/partners/logo-gmina-porabka.png"></img>

                    <img className="-m-6 scale-50" src="/assets/partners/logo-kolarsko-pl.png"></img>

                    <img className="-m-6 scale-50" src="/assets/partners/logo-pbw.png"></img>
                    <img className="-m-6 scale-50" src="/assets/partners/logo-pkp-cargo-service.png"></img>
                    <img className="-m-6 scale-50" src="/assets/partners/logo-power-of-science.png"></img>
                    <img className="-m-6 scale-50" src="/assets/partners/logo-ravelo.png"></img>
                    <img className="-m-6 scale-50" src="/assets/partners/logo-trek.png"></img>
                    <img className="-m-6 scale-50" src="/assets/partners/logo-turdetur.png"></img>
                    <img className="-m-6 scale-50" src="/assets/partners/logo-velonews-pl.png"></img>
                </div>
                ...
                <div className="max-w-6xl flex flex-wrap justify-center items-center">
                    <img className="-m-6 scale-50" src="/assets/partners/logo-kolarsko-pl.png"></img>
                    <img className="-m-6 ml-2 scale-50" src="/assets/partners/logo-turdetur.png"></img>
                    <img className="-m-6 scale-50" src="/assets/partners/logo-velonews-pl.png"></img>
                </div> */}
            </div>
